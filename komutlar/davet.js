...
.setDescription(`[Davet Linki](https://discordapp.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8)\n[Destek Sunucusu](https://discord.gg/dtqWPBV)
`)
